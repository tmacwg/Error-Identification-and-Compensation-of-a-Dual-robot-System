function [N,M,Desbs1,Desbs2] = FUN_Calculate(dQ,Q,DesdqR,Desbt,DesTe1s,DesTo2o1,DesTte2,numPt,MeaTe1s,MeaTte2,MeaTo2o1,E1,E2,E1_Des,E2_Des,M1,M2,matAng1,matAng2,Ps1,Do2o1,Dte2,De1s)
...
for i=1:nPt
    ...
    [G1i,DDS1i(i*4-3:i*4,:)]=CalG_Dualrobot1(Q1i,To2s1,MeaTe1s,Tts1,MeaTte2,Theta1i,Do2o1',De1s',Dte2',dQ,Q);  %计算G1
    [G2i,DDS2i(i*4-3:i*4,:)]=CalG_Dualrobot1(Q2i,To2s2,MeaTe1s,Tts2,MeaTte2,Theta2i,Do2o1',De1s',Dte2',dQ,Q);  %计算G2
    G1=[G1;G1i];
    G2=[G2;G2i];
